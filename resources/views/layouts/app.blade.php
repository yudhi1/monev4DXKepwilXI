...
<head>
    ...
    <style>
        ...
        .app-navbar .nav-link i { font-size: .95rem; }
        @media (min-width: 992px) and (max-width: 1399px) {
            .app-navbar .nav-link { padding: .4rem .55rem; font-size: .82rem; }
        }
        ...
        .app-navbar .dropdown-item:hover { background: #e8f0ff; color: #0b3d91; }
    ...
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse" id="nav">
            <ul class="navbar-nav me-auto">
                ...
                @role('admin')
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->is('users*','wilayahs*','cabangs*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown">
                            <i class="bi bi-gear"></i> Master
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ url('/users') }}"><i class="bi bi-people"></i> User</a></li>
                            <li><a class="dropdown-item" href="{{ url('/wilayahs') }}"><i class="bi bi-geo-alt"></i> Wilayah</a></li>
                            <li><a class="dropdown-item" href="{{ url('/cabangs') }}"><i class="bi bi-building"></i> Cabang</a></li>
                        </ul>
                    </li>
                @endrole
                @hasanyrole('admin|kedeputian_wilayah')
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->is('wigs*','wig-targets*','wig-realisasi*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown">
                            <i class="bi bi-bullseye"></i> WIG
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ url('/wigs') }}"><i class="bi bi-list-task"></i> Input Data WIG</a></li>
                            <li><a class="dropdown-item" href="{{ url('/wig-targets') }}"><i class="bi bi-flag"></i> Input Target WIG</a></li>
                            <li><a class="dropdown-item" href="{{ url('/wig-realisasi') }}"><i class="bi bi-clipboard-data"></i> Input Realisasi WIG Bulanan</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('lag-measures*') ? 'active' : '' }}" href="{{ url('/lag-measures') }}">
                ...
                @role('kantor_cabang')
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('wig-realisasi*') ? 'active' : '' }}" href="{{ url('/wig-realisasi') }}">
                            <i class="bi bi-clipboard-data"></i> Realisasi WIG
                        </a>
                    </li>
                @endrole
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is('lead-measures*','realisasi*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown">
                        <i class="bi bi-graph-up"></i> Lead Measure
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ url('/lead-measures') }}"><i class="bi bi-list-task"></i> Input Data Lead Measure</a></li>
                        <li><a class="dropdown-item" href="{{ url('/realisasi') }}"><i class="bi bi-clipboard-check"></i> Input Realisasi Lead Measure</a></li>
                    </ul>
                </li>
                @hasanyrole('admin|kedeputian_wilayah|kantor_cabang')
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->is('monitoring-prioritas*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown">
            ...
            <div class="d-flex align-items-center gap-2">
                <a class="nav-link {{ request()->is('panduan*') ? 'active' : '' }}" href="{{ url('/panduan') }}">
...
<script>
    ...
    window.swalToast = function (type, message) {
        Swal.fire({
            toast: true, position: 'top-end', icon: type || 'success',
            title: message, showConfirmButton: false, timer: 2500, timerProgressBar: true,
        });
    };
