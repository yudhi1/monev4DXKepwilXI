                                ...
                                @forelse($leads as $i => $lead)
                                    ...
                                    <tr wire:key="lead-{{ $lead->id }}-m{{ $minggu }}">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button type="button" x-show="editing[{{ $lead->id }}]" @click="editing[{{ $lead->id }}] = false; $wire.saveLead({{ $lead->id }})" class="btn btn-sm btn-success" title="Simpan" style="display:none">
